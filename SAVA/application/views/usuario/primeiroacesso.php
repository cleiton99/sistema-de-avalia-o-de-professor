...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <?php
            echo form_open("index.php/usuario/primeiroacesso", array('class' => 'form-signin'));
            echo MSG::getAlertMensagemClose(MSG::ALERT_DANGER, validation_errors());
            echo "<h2 class='form-signin-heading'>SAVA - PRIMEIRO ACESSO</h2>";
            ...
            echo form_input(array('type' => 'password', 'id' => 'senha', 'name' => 'senha', 'class' => 'form-control', 'placeholder' => 'DIGITE A SENHA'), set_value('senha'));
            echo form_button(array("class" => "btn btn-lg btn-primary btn-block", "content" => "CADASTRAR", "type" => "submit"));
            echo form_close();
            ?>
