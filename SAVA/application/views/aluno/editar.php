...
echo form_open("index.php/aluno/editar/".$aluno->id);
...
echo "<h2 class='form-signin-heading'>ALTERAR ALUNO</h2>";
echo "<div class='form-group'>";
echo form_label('Nome', 'nome');
echo form_input(array('type' => 'text', 'id' => 'nome', 'name' => 'nome', 'class' => 'form-control', 'placeholder' => 'DIGITE O NOME', 'autofocus' => true), set_value('nome', $aluno->nome));
echo "</div>";
echo "<div class='form-group'>";
echo form_label('Email', 'email');
echo form_input(array('type' => 'text', 'id' => 'email', 'name' => 'email', 'class' => 'form-control', 'placeholder' => 'DIGITE O EMAIL'), set_value('email', $aluno->usuario->email));
echo "</div>";
echo "<div class='form-group'>";
